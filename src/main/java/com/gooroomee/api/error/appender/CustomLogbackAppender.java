package com.gooroomee.api.error.appender;

import ch.qos.logback.classic.spi.ILoggingEvent;
import ch.qos.logback.classic.spi.StackTraceElementProxy;
import ch.qos.logback.core.UnsynchronizedAppenderBase;
import ch.qos.logback.core.util.ContextUtil;
import com.gooroomee.api.error.config.LogConfig;
import com.gooroomee.api.error.entity.ErrorLog;
import com.gooroomee.api.error.entity.ErrorLogService;
import com.gooroomee.api.error.util.JsonUtils;
...
public class CustomLogbackAppender extends UnsynchronizedAppenderBase<ILoggingEvent> {
	...
	private void toSlack(ErrorLog errorLog) {
		...
		system.setValue(errorLog.getSystemName());
...
//		System.out.println(errorLog.getHeaderMap());
//
...
//		slackAttachment.setTitleLink("http://log.test.com");
		slackAttachment.setText(errorLog.getTraceType());
	...
	public ErrorLog getErrorLog(ILoggingEvent loggingEvent) {
		if (loggingEvent.getLevel().isGreaterOrEqual(logConfig.getLevel())) {
			...
			errorLog.setSystemName("testSystem");
			...
			if (loggingEvent.getThrowableProxy() != null) {
				errorLog.setTraceType(getStackTrace(loggingEvent.getThrowableProxy().getStackTraceElementProxyArray()));
			}
