        ...
        http
                ...
                .and()
                    .authorizeRequests() // 사용권한 체크
                        .antMatchers("/auth/signin", "/getFilesUrl/**","/auth/signup", "/post/free","/posts/free", "/auth/member", "/auth/member/**", "/api/v1/test3", "/post/**","/comments/**", "/testUpload/**","testDownload/**").permitAll() // 가입 및 로그인은 누구나 접근가능
